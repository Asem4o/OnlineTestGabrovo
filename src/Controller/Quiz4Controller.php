    ...
    public function index(Request $request, SessionInterface $session): Response
    {
        $questions = [
            ...
            [
                ...
                'answers' => [
                    ['id' => 'a', 'text' => 'Операционната система е напълно независима от апаратното оборудване.', 'isCorrect' => true],
                    ['id' => 'b', 'text' => 'Операционната система изисква драйвери за взаимодействие с апаратното оборудване', 'isCorrect' => false],
                    ['id' => 'c', 'text' => ' Операционната система може да работи само с определен тип апаратно оборудване.', 'isCorrect' => true],
